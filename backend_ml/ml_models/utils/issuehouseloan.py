...
if __name__ == "__main__":
    ...
    # Call the function to get factor BPS and print the result
     # Get and print the factor BPS for different customer profiles

    # Factor BPS for sample profile
    factor_bps_sample = get_factor_bps(sample_profile)
    print("Sample Profile Factor BPS:")
    for feature, bps in factor_bps_sample.items():
        print(f"{feature}: {bps}")

    # Factor BPS for good customer (best profile)
    # factor_bps_good_customer = get_factor_bps(best)
    # print("Good Customer Factor BPS:")
    # for feature, bps in factor_bps_good_customer.items():
    #     print(f"{feature}: {bps}")

    # # Factor BPS for bad customer (bad profile)
    # factor_bps_bad_customer = get_factor_bps(bad)
    # print("Bad Customer Factor BPS:")
    # for feature, bps in factor_bps_bad_customer.items():
    #     print(f"{feature}: {bps}")

    # # Factor BPS for new customer with no history
    # factor_bps_new_customer = get_factor_bps(new_customer_no_history)
    # print("New Customer (No History) Factor BPS:")
    # for feature, bps in factor_bps_new_customer.items():
    #     print(f"{feature}: {bps}")
